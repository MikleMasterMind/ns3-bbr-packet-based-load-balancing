...
ThroughputSampler()
{
  ...
  int main (int argc, char *argv[])
  {
    ...
    // Directories
    std::vector<std::string> resultPathParts = {"result/data/for_bbr"};
    ...
    {
        resultPathParts.push_back("cubic");
    }
    //resultPathParts.push_back("bbr");
